...
local Window = OrionLib:MakeWindow({Name = "Tsou Hub Remake", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Tsou Hub Remake"})

OrionLib:MakeNotification({
	Name = "Tsou Hub Remake",
...
W:AddLabel("[+] Tsou Hub Remake is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Tsou Hub Remake(Noitification)",
